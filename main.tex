...
e.g., \cite{megill2021cellxgene}, \cite{chelaru2014epiviz}, \code{cirrocumulus (https://cirrocumulus.readthedocs.io/en/latest/)},  \cite{kerpedjiev2018higlass} and every R/Shiny application ever.
...
We collected timings on an Intel Core i7-8850H CPU (2.60GHz, 6 cores, 32 GB memory)  using 8 web workers for \code{kana} (see below) and 8 threads for the executable.
...
\hline
        Zeisel   & 3005   & 6.86 &  0.10 & 5.60 &  0.05 \\
        Paul     & 10368  & 17.40 &  0.46 & 13.52 &  0.38 \\
        Bach     & 25806  & 56.58 &  0.33 & 43.33 &  0.39 \\
        Ernst    & 68937  & 157.17 & 0.66 & 54.67 & 1.86 \\
        Bacher   & 104417 & 226.82 & 2.18 & 170.32 & 1.34 \\
        Zilionis & 173954 & 268.83 & 4.52 & 183.77 & 2.46 \\
\hline
\end{tabular}
\end{center}
\end{table}
...
\hline
        Zeisel   & 3005  &  11.3 & \jay{??} & ? & 158.20 & 0.05 \\
        Paul     & 10368 &  11.9 & \jay{??} & ? & 306.26 & 0.06 \\
        Bach     & 25806 &  61.2 & \jay{??} & ? & 965.17 & 0.03 \\
        Ernst    & 68937 & 163.1 & \jay{??} & ? & 2512.08 & 0.06 \\
        Bacher   & 104417& 143.0 & \jay{??} & ? & 2437.75 & 1.34 \\
        Zilionis & 173954&  53.7 & \jay{??} & ? & 2600.66 & 0.04 \\
\hline
\end{tabular}
\end{center}
\end{table}
...
The code for to benchmark memory and time of the analysis for both kana and scrna-cli is available on GitHub (\url{https://github.com/jkanche/kana.perf/})
