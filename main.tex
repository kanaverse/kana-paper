...
providing some new opportunities to repurpose the browser as an interactive data analysis tool.
...
and then render the results with appropriate visualizations on a interface that is highly familiar to the user.
